...
- Frontend GitHub Pages: `v4.27.0`
- Service Worker/PWA: `v4.27.0`
...
18. `Fase 27` - iniciada em v4.27.0 com fechamento diario no Painel Admin. O checklist cruza LANCAMENTOS, CLIENTES/OS, aceites, custos e fila offline local, gera pendencias acionaveis e permite copiar um resumo de encerramento sem alterar backend ou dados operacionais.
