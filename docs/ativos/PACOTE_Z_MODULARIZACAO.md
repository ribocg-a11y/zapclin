...
| `index.html` | HTML + CSS inline + restante do JS (~4.600 linhas) |

**Progresso:** ~5% — 4 módulos extraídos; meta final shell HTML < 200 linhas JS inline.
