/**
 * ZapClin — seed OAuth: LANÇAMENTOS 01–13/08/2026 com totais fixos.
 * SEED_VERSION=1
 *
 * Totais alvo (valor ativo, exclui CANCELADO) — BR comma → float:
 *   01/08=270 | 02/08=341.90 | 03/08=387.08 | 04/08=429 | 05/08=90
 *   06/08=108 | 07/08=378.08 | 08/08=211 | 09/08=160 | 10/08=375
 *   11/08=371 | 12/08=345 | 13/08=432.81
 *
 ...
 *   node seed-lancamentos-ago01-13.js --dry-run
 *   node seed-lancamentos-ago01-13.js --i-know-what-im-doing
 *
 * Cloud (com GOOGLE_CLIENT_ID / SECRET / REFRESH_TOKEN):
 *   node scripts/oauth-sheets/seed-lancamentos-ago01-13.js --i-know-what-im-doing
 */
'use strict';
...
const TARGETS = [
  ...
  { dia: 2, mes: 8, total: 341.9 },
  { dia: 3, mes: 8, total: 387.08 },
...
/**
 * Alvo pode ter centavos (ex. 341.90). Catálogo é inteiro →
...
async function main() {
  console.log('seed-lancamentos-ago01-13 SEED_VERSION=' + SEED_VERSION);
  ...
  console.log('\nSeed LANÇAMENTOS 01–13/08 concluído.');
}
