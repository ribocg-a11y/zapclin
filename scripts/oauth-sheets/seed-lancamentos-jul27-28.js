/**
 * ZapClin — seed OAuth: LANÇAMENTOS 27–28/07/2026 com totais fixos.
 * SEED_VERSION=1
 *
 ...
 *   node seed-lancamentos-jul27-28.js --dry-run
 *   node seed-lancamentos-jul27-28.js --i-know-what-im-doing
 */
'use strict';
...
const TARGETS = [
  { dia: 27, mes: 7, total: 378 },
  { dia: 28, mes: 7, total: 340 },
];
...
async function main() {
  console.log('seed-lancamentos-jul27-28 SEED_VERSION=' + SEED_VERSION);
  ...
  console.log('\nSeed LANÇAMENTOS 27–28/07 concluído.');
}
