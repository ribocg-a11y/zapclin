/**
 * ZapClin — seed OAuth: LANÇAMENTOS 20–26/07/2026 com totais fixos.
 * SEED_VERSION=1
 *
 * Totais alvo (valor ativo, exclui CANCELADO):
 *   20/07 = 274 | 21/07 = 255 | 22/07 = 360 | 23/07 = 330
 *   24/07 = 266 | 25/07 = 350 | 26/07 = 311
 *
 ...
 *   node seed-lancamentos-jul20-26.js --dry-run
 *   node seed-lancamentos-jul20-26.js --i-know-what-im-doing
 */
'use strict';
...
const TARGETS = [
  ...
  { dia: 21, mes: 7, total: 255 },
  { dia: 22, mes: 7, total: 360 },
  { dia: 23, mes: 7, total: 330 },
  { dia: 24, mes: 7, total: 266 },
  { dia: 25, mes: 7, total: 350 },
  { dia: 26, mes: 7, total: 311 },
];
...
async function main() {
  console.log('seed-lancamentos-jul20-26 SEED_VERSION=' + SEED_VERSION);
  ...
  console.log('\nSeed LANÇAMENTOS 20–26/07 concluído.');
}
