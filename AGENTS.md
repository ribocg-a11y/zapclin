...
|--------|-------------|-------------|
| Frontend | **v4.36.5** | GitHub Pages `?force=v4.36.5` |
| Service Worker | **v4.36.5** | `sw.js` |
...
- **Produção live:** FE/SW **v4.36.5** · GAS ping **3.57**
...
- **Próximo humano:** 1) `?force=v4.36.5` 2) Equipe: cadastrar pelo nome 3) aceite WhatsApp · Golden
